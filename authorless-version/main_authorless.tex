...
% Resolve the manuscript's shared assets from this standalone subdirectory.
\graphicspath{{../}}
...
% Required by the supplement's original figure notes.
...
% Preserve the original supplement float placement in the combined build.
\makeatletter
\setlength{\@fptop}{0pt}
...
% Suppress acmart's empty contact-information heading in the authorless copy.
\makeatletter
\renewcommand{\@mkauthorsaddresses}{}
\makeatother
...
% Preserve the supplement as source inputs rather than copying its prose here.
\appendix
\makeatletter

...
Across these systems, the serving cluster forms one governed short-lived lifecycle: \emph{admit -> place -> share -> reclaim -> transfer -> restore}. The family-level differences matter because different systems attach to different stages of that loop.
